...
const MANUALS: Record<string, { label: string; color: string; sections: Section[] }> = {
  inspector: {
    ...
    sections: [
      ...
      {
        title: "Sistemas Contra Incendio (SCI)",
        icon: "🔥",
        items: [
          "En el Home, toca la tarjeta roja 'Sistemas SCI' para registrar un servicio de SCI.",
          "Paso 1 — Encabezado: selecciona cliente, tipo de sistema (CO₂, Rociadores, Espuma, etc.), ubicación, fecha y técnico.",
          "Paso 2 — Checklist: responde cada ítem del sistema: Conforme / No conforme / N/A.",
          "Paso 3 — Cierre: agrega fotos de evidencia y observaciones finales, luego toca 'Enviar servicio SCI'.",
          "El folio generado (SCI-AAAA-NNNN) queda disponible en la plataforma para generar el PDF.",
        ],
      },
      {
        title: "Línea de Vida",
        icon: "🔗",
        items: [
          "En el Home, toca la tarjeta morada 'Línea de Vida' para iniciar una inspección.",
          "Paso 1 — Encabezado: selecciona cliente, ubicación y fecha.",
          "Paso 2 — Checklist NOM-009 / ANSI Z359: arnés, anclajes, conectores, línea de vida y certificación.",
          "Los ítems marcados con ⚠ son críticos — una sola falla reprueba el equipo.",
          "Paso 3 — Cierre: agrega fotos y observaciones.",
          "El reporte queda en la plataforma → Línea de Vida → Inspecciones LV.",
        ],
      },
      {
        ...
        icon: "🧯",
        items: [
          "En el Home encontrarás 3 filas de botones de acceso rápido:",
          "Equipos de seguridad: ERA, Equipo Bombero, Hidrante, Lámpara de Emergencia, Puerta de Emergencia, Kit Derrame, Silla de Ruedas, Camilla, Otro.",
          "Inspección SCI (NFPA): CO₂, Rociadores, Espuma AFFF, Bomba CI, Alarma, Supresión Cocinas, Agente Limpio, SCI General.",
          "Regaderas y Lavaojos: Fija, Portátil Gravedad, Portátil Presión, Lavaojos Fijo, variantes combinadas.",
          "Al tocar un tipo, el checklist carga automáticamente con los ítems de la norma aplicable.",
          "Las inspecciones de campo se sincronizan con la plataforma y generan certificado PDF.",
          "Si no hay internet, se guardan localmente y se envían al reconectar.",
        ],
      },
      {
        ...
        icon: "📜",
        items: [
          "Extintores: NOM-154-SCFI-2005 / NOM-002-STPS-2010.",
          "Líneas de vida / arneses: NOM-009-STPS-2011 · ANSI Z359.",
          "ERA (Respiración autónoma): NFPA 1981 · NOM-116-STPS-2009.",
          "Equipo de bombero: NFPA 1971.",
          "Sistemas CO₂: NFPA 12.",
          "Rociadores automáticos: NFPA 13 · NFPA 25.",
          "Espuma AFFF: NFPA 16.",
          "Bombas contra incendio: NFPA 20.",
          "Alarmas de incendio: NFPA 72.",
          "Supresión en cocinas: NFPA 96.",
          "Agente limpio (FM-200, HCFC, etc.): NFPA 2001.",
          "Hidrantes y mangueras: NOM-002-STPS-2010 · NFPA 14.",
          "Regaderas y lavaojos de emergencia: ANSI Z358.1 · NOM-010-STPS-2014.",
          "Lámparas de emergencia: NOM-001-SEDE-2012 · NFPA 101.",
          "Puertas de emergencia: NOM-026-STPS-2008 · NFPA 101.",
          "Kit de derrames: NOM-005-STPS-1998.",
          "Camilla / silla de ruedas de emergencia: NOM-034-SSA3-2013.",
        ],
      },
      {
        title: "Soporte",
        ...
        items: [
          ...
          `Versión actual: ${Constants.expoConfig?.version ?? "?"}. Asegúrate de tener la APK más reciente instalada.`,
