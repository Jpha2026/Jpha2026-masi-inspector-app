...
const s = StyleSheet.create({
  ...
  actionCard:   { width: "48%", borderRadius: 16, overflow: "hidden", elevation: 4, shadowColor: "#000", shadowOpacity: 0.15, shadowRadius: 8, shadowOffset: { width: 0, height: 3 } },
  actionGrad:   { paddingVertical: 20, paddingHorizontal: 10, alignItems: "center", minHeight: 100, justifyContent: "center", gap: 6 },
  actionIcon:   { fontSize: 26 },
  actionLabel:  { color: "#fff", fontWeight: "800", fontSize: 13, textAlign: "center", lineHeight: 18 },
