...
const styles = StyleSheet.create({
  ...
  resultBtn: { flex: 1, paddingVertical: 13, borderRadius: 10, borderWidth: 1.5, borderColor: "#D0D9EB", alignItems: "center" },
  resultBtnText: { fontSize: 14, fontWeight: "800", color: "#8A9BBE" },
