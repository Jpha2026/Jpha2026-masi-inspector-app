        ...
        <View style={ss.overlay}>
          <View style={ss.picker}>
            ...
            <View style={ss.calHeader}>
              {mode === "cal" ? (
                <>
                  ...
                  <TouchableOpacity onPress={() => setMode("year")} activeOpacity={0.7} style={ss.monthYearBtn}>
                ...
                <TouchableOpacity onPress={() => setMode("cal")} activeOpacity={0.7} style={ss.monthYearBtn}>
                  <Text style={ss.monthYear}>Selecciona año ✕</Text>
                </TouchableOpacity>
              )}
            </View>
            ...
            {mode === "year" && (
              ...
              >
                <View style={ss.yearGrid}>
                  {YEARS.map(y => (
                    <TouchableOpacity
                      key={y}
                      onPress={() => selectYear(y)}
                      style={[ss.yearCell, y === viewYear && ss.yearCellSelected]}
                      activeOpacity={0.7}
                    >
                      <Text style={[ss.yearText, y === viewYear && ss.yearTextSelected]}>
                        {y}
                      </Text>
                    </TouchableOpacity>
                  ))}
...
const ss = StyleSheet.create({
  ...
  yearCell:          { width: "25%", paddingVertical: 10, alignItems: "center", borderRadius: 10 },
  yearCellSelected:  { backgroundColor: "#122B60" },
  yearText:          { fontSize: 15, color: "#1A2740", fontWeight: "600" },
  yearTextSelected:  { color: "#fff", fontWeight: "800" },
